...
def unpack_message_headers(client: socket) -> Tuple[bytes, int, int, int]:
    """
...
def unpack_message(
        ...
        payload_size: int, server_version: int, codes: Type[T],
    ...
    @param server_version: The actual version of the server.
